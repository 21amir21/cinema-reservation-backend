...
<body>
  ...
  <form id="submit-form" action="editmovieform.php?id=<?= $movie["id"] ?>" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" id="backgroundimage" placeholder="Enter Movie Background Image" name="backgroundimage" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="date" id="releasedate" placeholder="Enter Movie Release Date" name="releasedate" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="time" id="runningtime" placeholder="Enter Movie Running Time" name="runningtime" />
    </div>
    <div class="form-group">
